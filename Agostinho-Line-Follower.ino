...
//PWM        50       -----       60         -----     70       -----    80     -----     90          -----    100     -----      110*    -----     120   -------    130    -----    140    ----- 150 ------ 160 --------- 170           ----- 200                         
//Kp:      0.04     -----        0.04       -----     0.18     -----    0.19   -----     0.19      -----      0.19    -----      0.12  -----       0.12 ------      0.120  -----     0.12   -----     ------     ---------               ----- 0.07
//Ki:        0        -----       0          -----              -----           -----                 -----            -----             -----           ------            -----             -----     ------     ---------              ----- 
//Kd:      0.20     -----        0.3        -----     0.4    -----      0.9   -----      1.10         -----   1.11     -----     0.8 -----        -0.80 ------       0.9  -----      1.1       -----     ------     ---------            ----- 1.5  
//Tensão:    -        -----      7.97        -----    7.67      -----    7.32   -----    8.2        -----   7.9      -----      7.9    -----      7.9 -------       7.95   -----     7.5        -----     ------     ---------



int leitura1 = 0, leitura2 = 0, aux = 0, aux2 = 1023, pwm = 200, pwmi = 100, outBack = 3150;
double offset, erro , p, integral = 0, kp = 0.07, ki = 0, i, Turn, kd = 1.5, d, erroAnterior = 0 ;
double MotorA, MotorB; //Valor de PWM dos motores de 0 a 255
#define SaidaA 9
#define SaidaB 3
...
int i;
  for (i = 0; i < 70; i++)  // make the calibration take about 2 seconds
  {
    qtra.calibrate();
    delay(5);
...
void loop() {
  ...
  if(sensor_values[7] < 200) {
    while(sensor_values[6] > 600){//sentido 2 sensor_values[8] < 50
